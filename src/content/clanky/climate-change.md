...
description: Climate change is one of the biggest challenges we face today. Read on to learn what the problem is and what solutions exist in the areas of mitigation and adaptation.
pubDate: 2024-05-30
...
Mitigation of climate change actually means releasing less greenhouse gas (mainly CO2 and methane) to the air. That is an enormous task. In fact, every single person on this planet needs to change their way of life somehow.

First and foremost, we mustn't worsen this already bad situation. That means, for instance, not cutting down forests, that absorb CO2 and thereby decelerate climate change. To give you an idea - Brasil, on which land most of the world's largest rainforest (Amazon) grows, has one of the worst greenhouse gas balances because of mass deforestation.

Next we must surely prevent future release of CO2. There's no other way than turning our life upside down - use renewable sources of energy (e.g., build solar and wind power plants and replace the coal ones), travel by train, boat or electromobile and replace cars running on fossil fuels, produce batteries instead of coal industry, and so on. At the same time, we need many other inventions and technologies that help with emission decrease.
...
Climate change mitigation has been a topic of discussion for a long time. No less and maybe even more important thing is adaptation to climate change. The point is that even if all the emissions would stop being released right now as if by magic, climate would still continue to change because molecules of CO2 stay in the atmosphere for about a hundred years. This is why it's essential that we be able to adapt to the climate change.

Again, EU is a good example. It's got the Adaptation plan already developed and is beginning to implement it. Hundreds of researchers involved in this plan. I will try to introduce it for you a little. Similar plans should be developed across the world in the near future.

**Adaptation needs to be smart, systematic, rapid, and international.**
...
Time plays against us. Unlike Covid, that we'll hopefully solve soon, no vaccination exists for climate change and we need to figure out the solution rapidly and carry it out.
